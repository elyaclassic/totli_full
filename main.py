...
async def qoldiqlar_tovar_hujjat_tasdiqlash(
    ...
    for item in doc.items:
        ...
        # Adjustment absolute miqdorga olib kelishi uchun faqat farqni helper orqali qo'llaymiz.
...
def _do_complete_production_stock(db, production, recipe):
    ...
    # Tayyor mahsulot kirimini helper bajaradi va harakat tarixini yozadi.
    create_stock_movement(
        db=db,
